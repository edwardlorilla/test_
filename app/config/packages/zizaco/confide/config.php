...
return array(
    ...
    */
    ...
    |
    */
    'login_form' =>             'vendor.zizaco.confide.src.views.login',
    'signup_form' =>            'vendor.zizaco.confide.src.views.signup',
    'forgot_password_form' =>   'vendor.zizaco.confide.src.views.forgot_password',
    'reset_password_form' =>    'vendor.zizaco.confide.src.views.reset_password',
    ...
    |
    */
    'email_reset_password' =>       'vendor.zizaco.confide.src.views.emails.passwordreset', // with $user and $token.
    'email_account_confirmation' => 'vendor.zizaco.confide.src.views.emails.confirm', // with $user
